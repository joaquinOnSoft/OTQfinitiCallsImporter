...
usage: `java -jar OTQfinitiCallsImporter-23.01.03.jar`
...
```
$ java -jar OTQfinitiCallsImporter-23.01.03.jar -c client_i_mapping.json -o call_recordinds.xls -p "\\WIN-FH7JGOHVC21\Recordings"
```
 ...
 * **ID**
 * **Date**: format matches this pattern `ddmmaaaa_hhmmss`
 * **Service**
 * **Agent**
 * **Duration**
 * **Telephone**: The first 4 digits correspond to a route to be ignored for processing.
