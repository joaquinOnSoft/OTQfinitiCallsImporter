...
**OpenText Qfiniti Data Importer** requires and Excel file  with the metadata associated with each call recording.
We call OUTPUT file to this file. 

**OTQfinitCallsImporter** requires a JSON that defines the mapping between the input fields and the output field. Not all the fields should be mapped, some of them are populated with a default value, an automatically generated value, or simply ignored.
