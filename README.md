...
usage: `java -jar OTQfinitiCallsImporter-23.01.04.jar`
...
```
$ java -jar OTQfinitiCallsImporter-23.01.04.jar -c client_i_mapping.json -o call_recordinds.xls -p "\\WIN-FH7JGOHVC21\Recordings"
```
