...
usage: `java -jar OTQfinitiCallsImporter-21.3.187.jar`
...
```
$ java -jar OTQfinitiCallsImporter-22.06.15.jar -c client_i_mapping.json -o call_recordinds.xls -p "\\WIN-FH7JGOHVC21\Recordings"
```
