 ...
 * </ul>
 */ 
public class PlanetaNamingConventionDateFiller extends PlanetaNamingConventionFiller {
		
	public PlanetaNamingConventionDateFiller(CallRecording call, String path, String fileName) {
		super(call, path, fileName);
	}

	public PlanetaNamingConventionDateFiller(CallRecording call, String filePath) {
		super(call, filePath);
	}
