 ...
 */
public class UserId2UserFullNameTransformer extends UserId2UserNamesTransformer {

	
	public UserId2UserFullNameTransformer(String path) {
		super(path);
	}
	...
	public String transform(String userId) {
		...
		if(userId != null) {
			...
			if (names != null && names.length == 2) {
				fullName = names[INDEX_SURNAME] + ", " + names[INDEX_NAME];
			}
		}
		else {
			fullName = "";
